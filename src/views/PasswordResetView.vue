<script setup>
    ...
    async function resetPassword() {
        ...
        if (!isPasswordValid()) {
            showErrorBanner('Password must be at least 8 characters long and contain at least one uppercase letter, one lowercase letter and one number')
            return;
        }
        ...
        <div class="card shadow-lg p-4" style="max-width: 400px; width: 100%">
            ...
            <form @submit.prevent="resetPassword">
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="username" v-model="newPassword"
                        placeholder="New password" />
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label">Confirm new password</label>
                    <input type="password" class="form-control" id="email" v-model="confirmNewPassword"
